...
if __name__=='__main__':
    ...
    # 自适应kalmann滤波预测
    IC=adaptiveKalmannFilterIteration(avgICdelay,y_IC,mu=0.9999,sigma1=0.0001,sigma2=0.0001)
    ...
    dates=avgICdelay.reset_index()['tradeDate']
    fig, ax = plt.subplots()
...
#            davgIC: cum_day_profit=1.707805247  annual_return=0.125570337  max_dropdown=-0.073720436
#####################################################################################################